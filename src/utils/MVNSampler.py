...
Implements minimax-tilting acceptance–rejection sampling for a multivariate normal
distribution subject to axis-aligned box constraints. Used by :class:`utils.distributionUtils.MVNormal`
and :class:`utils.distributionUtils.MVLognormal` to draw constrained (x, y) or (w, h) prior samples
during mask generation.

Code's source: https://github.com/brunzema/truncated-mvn-sampler/blob/main/minimax_tilting_sampler.py
"""
...
# Small constant to avoid division-by-zero in log-probability computations.
EPS = 10e-15
